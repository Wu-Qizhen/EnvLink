...
val BluePurple = Color(99, 102, 241)
val Blue = Color(59, 130, 246)
val DarkBlue = Color(18, 77, 220, 255)
val PaleBlue = Color(100, 182, 229)
val SkyBlue = Color(41, 218, 255)
...
val BrownYellow = Color(94, 76, 46)
val OrangeYellow = Color(245, 158, 11)
val Orange = Color(249, 114, 28)
val OrangeRed = Color(214, 77, 91)
val Red = Color(236, 37, 55)
val Pink = Color(251, 114, 153)
val PurplePink = Color(220, 68, 144)
val GreenWhite = Color(240, 253, 244)
